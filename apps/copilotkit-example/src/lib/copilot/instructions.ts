import { focusModePrompts } from "./focus-mode-prompts";
...
4. Natural Language Understanding:
   ...
   - "I need to concentrate on important tasks"

${focusModePrompts.systemPrompt}
...
export const COPILOT_LABELS = {
  ...
  initial: "👋 Ready to help organize your tasks! What would you like to do?",
};
